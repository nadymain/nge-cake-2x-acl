<div class="main_top clear">
	...
	<a class="main_top-action" title="Add New" href="<?php echo $this->Html->url('/images/iframeindex?type='.($this->request->query('type') === 'modal' ? 'modal' : 'ckeditor&CKEditorFuncNum='.$this->request->query('CKEditorFuncNum')), true) ?>">
